...
public class Inventory {
    ...
    public void addItem(int level, javax.swing.JTextArea eventTextBox) {
        ...
        int levelModifier = rand.nextInt(20) + 1;
        switch(levelModifier) { //randomly have items be higher or lower level
            case(1):
                level = level + 2;
                break;
            case(2): case(3):
    ...
    public void equip(PlayerStats player, javax.swing.JTextArea eventTextBox, boolean deleteMode) {
        ...
        if (deleteMode == true) { //Removes item from inventory if in delete mode
            items[selection][0] = " ";
            items[selection][1] = " ";
        }
            ...
            player.setAttack(attackBonus); //increases attack
